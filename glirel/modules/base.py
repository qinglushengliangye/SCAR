...
def insert_entity_markers(tokens, span_idx, relations, entity_start_token, entity_end_token):
    ...
    for rel in relations:
        ...
        try:
            ...
            print(f"WARNING: head_idx {head_idx} not found in span2adjusted_span, skipping")
            continue
        try:
            adjusted_tail_idx = span2adjusted_span[tail_idx]
        except:
            print(f"WARNING: tail_idx {tail_idx} not found in span2adjusted_span, skipping")
            continue
    ...
    def collate_fn(self, batch_list, relation_types=None, train_relation_types=None, device=None):
        ...
        if relation_types is None:
            ...
            for b in batch_list:
                ...
                if self.base_config.coreference_label is not None:
